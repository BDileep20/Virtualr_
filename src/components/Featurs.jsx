  ...
  return (
    <div className='relative mt-20 border-b border-neutral-800 min-h-[800px]'>
        <div className="text-center">
            <span className="bg-neutral-900 text-orange-500 rounded-full h-6 text-5m font-medium px-2 py-1 uppercase">
              feature
            </span>
            <h2 className='text-2xl sm:text-4xl lg:text-5xl mt-10 lg:mt-20 tracking-wide'>Easily build 
